...
# FIXED: Simplified analysis function that works in deployed environment
def run_comprehensive_analysis(client, rag_model):
    """Run comprehensive analysis - FIXED for deployment"""
    ...
    for idx, category in enumerate(category_order):
        ...
        try:
            ...
            status_placeholder.text(f"🔍 Analyzing {category.title()} information... ({idx+1}/{total_categories})")
            ...
            # Store results using dictionary notation for better persistence
            if parsed_results:
    ...
    status_placeholder.text("✅ Complete analysis finished!")
...
# FIXED: Initialize session state with dictionary notation for better persistence
...
You are currently analyzing {context_info}."""
        ...
        # FIXED: Check if analysis has been completed using dictionary notation
